// VENDORED from tropel/js/scripting-api/bru.js (D:\tropel) - DO NOT EDIT.
// KnockPort runs these shims over a TS-implemented __tropel_pm_* bridge
// until M3 swaps in the wasm runtime (same shims, Rust bridges).
// ── bru.* API for Tropel ───────────────────────────────────────────────────
